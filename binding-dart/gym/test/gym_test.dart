// -*- compile-command: "cd .. && pub run test"; -*-
...
class MockGymClient extends Mock implements GymClient {}

void main() {
  MockGymClient client;

  setUp(() {
    client = new MockGymClient();
  });

  group('listAll()', () {
    test('constructs correct path', () async {
      final all = await client.listAll();

      verify(client.getJSON('/repos/o/n/git/blobs/sh'));
    });
  });
  ...
  group('createBlob()', () {
    test('constructs correct path', () {
      ...
      verify(client.postJSON('/repos/o/n/git/blobs',
    ...
    test('creates valid JSON body', () {
      ...
      git.createBlob(repo, blob);
      var body = captureSentBody(client);
  ...
  group('getCommit()', () {
    test('constructs correct path', () {
      ...
      verify(client.getJSON('/repos/o/n/git/commits/sh',
  ...
  group('createCommit()', () {
    test('constructs correct path', () {
      ...
      verify(client.postJSON('/repos/o/n/git/commits',
  ...
  group('getReference()', () {
    test('constructs correct path', () {
      ...
      verify(client.getJSON('/repos/o/n/git/refs/heads/b',
  ...
  group('createReference()', () {
    ...
    test('constructs correct path', () {
      ...
      verify(client.postJSON('/repos/o/n/git/refs',
  ...
  group('editReference()', () {
    test('constructs correct path', () {
      ...
      // then
      verify(client.request('PATCH', '/repos/o/n/git/refs/heads/b',
    ...
    test('creates valid JSON body', () {
      ...
      // then
      var captured = verify(client.request(any, any,
  ...
  group('deleteReference()', () {
    test('constructs correct path', () {
      ...
      // then
      verify(client.request('DELETE', '/repos/o/n/git/refs/heads/b'));
    });
  });
  ...
  group('getTag()', () {
    test('constructs correct path', () {
      ...
      verify(client.getJSON('/repos/o/n/git/tags/someSHA',
  ...
  group('createTag()', () {
    ...
    test('constructs correct path', () {
      ...
      verify(client.postJSON('/repos/o/n/git/tags',
  ...
  group('getTree()', () {
    test('constructs correct path', () {
      ...
      verify(client.getJSON('/repos/o/n/git/trees/sh',
  ...
  group('getTree(recursive: true)', () {
    test('constructs correct path', () {
      ...
      verify(client.getJSON('/repos/o/n/git/trees/sh?recursive=1',
          convert: (j) => new GitTree.fromJson(j), statusCode: StatusCodes.OK));
    });
  });
  ...
  group('createTree()', () {
    test('constructs correct path', () {
      ...
      verify(client.postJSON('/repos/o/n/git/trees',
...
Map<String, dynamic> captureSentBody(MockGymClient client) {
  var bodyString = verify(
      client.postJSON(any, captureAny, convert: any))
      .captured
      .single;
